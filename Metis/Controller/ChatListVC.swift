...
class ChatListVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    lazy var leftButton: UIBarButtonItem = {
        ...
        let button  = UIBarButtonItem.init(image: image, style: .plain, target: self, action: #selector(ChatListVC.showProfile))
        return button
    }()
   ...
   // MARK: Methods
    func customization()  {
        ...
        let rightButton = UIBarButtonItem.init(image: icon!, style: .plain, target: self, action: #selector(ChatListVC.showContacts))
